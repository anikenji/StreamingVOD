...
define('DB_USER', 'root');
define('DB_PASS', 'YOUR_DB_PASSWORD'); // Update with your password
...
// ============================================
define('BASE_URL', 'https://your-domain.com/'); // Update for production
...
// ============================================
define('JWPLAYER_KEY', 'YOUR_JWPLAYER_KEY');
...
// ============================================
define('STREAM_SECRET_KEY', 'YOUR_RANDOM_SECRET_KEY_HERE'); // Change this!
define('STREAM_TOKEN_EXPIRY', 4 * 60 * 60); // 4 hours
define('ALLOWED_EMBED_DOMAINS', ['your-domain.com', 'localhost']);
